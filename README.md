...
A local AI chatbot that can answer questions from personal documents using Retrieval-Augmented Generation (RAG). It can work as secure offline AI assistant that answers business FAQs and retrieve key insights like policies, reports, or technical information from internal documents.
